<template>
	<div id="app" class="bg-gray-200">
		<header class="bg-gray-900 flex justify-between items-center content-center px-4 py-3">
			<div>
				<img src="./assets/logo.svg" class="h-8 w-auto" />
			</div>
		...
		<section class="flex justify-between bg-gray-800 px-4 py-3">
			<div class="relative">
				<div class="flex items-center absolute inset-y-0 left-0 pl-3">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 fill-current text-gray-500">
				...
				<input class="bg-gray-900 text-white rounded px-8 py-3" placeholder="Search by keywords" />
			</div>
